...
const SortableFieldItem: React.FC<{ 
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "flex items-center gap-3 p-3 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl mb-2 group shadow-sm hover:shadow-md transition-all",
        !field.enabled && "opacity-50 grayscale"
      )}
    >
      <div {...attributes} {...listeners} className="cursor-grab text-slate-300 dark:text-slate-700 hover:text-slate-600 dark:hover:text-slate-400 transition-colors">
      ...
      <div className="flex-1 flex flex-col">
        <div className="flex items-center gap-2">
          ...
          {field.isCustom && <span className="bg-emerald-100 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-[8px] px-1.5 py-0.5 rounded-full font-black uppercase">Tự tạo</span>}
        </div>
        {field.type === 'text' && field.isCustom && (
           <input 
             ...
             className="text-xs font-bold text-slate-900 dark:text-white bg-transparent border-b border-dashed border-slate-200 dark:border-slate-800 focus:border-emerald-500 focus:ring-0 p-0 h-6 outline-none"
           />
        )}
      </div>
      ...
      <div className="flex items-center gap-1">
        <button 
          ...
          className={cn(
            ...
            field.enabled ? "text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-500/10" : "text-slate-300 dark:text-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800"
          )}
        >
        ...
        {field.isCustom && (
          <button 
            ...
            className="p-1.5 text-slate-300 dark:text-slate-700 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg transition-colors"
          >
            <Trash2 size={16} />
          </button>
        )}
...
const SettingsPage = () => {
  ...
  return (
    <div className="p-10 max-w-4xl h-full overflow-auto outline-none no-scrollbar">
      ...
      {/* Tabs */}
      <div className="flex gap-1 bg-slate-100 dark:bg-slate-900 p-1 rounded-2xl w-fit mb-8 shadow-inner">
        <button
          onClick={() => setActiveTab('overview')}
          className={cn(
            "flex items-center gap-2 px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all",
            activeTab === 'overview' ? "bg-white dark:bg-slate-800 text-slate-900 dark:text-white shadow-sm" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"
          )}
        >
          <Building2 size={16} />
          Tổng quan
        ...
        <button
          ...
          className={cn(
            "flex items-center gap-2 px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all",
            activeTab === 'payment' ? "bg-white dark:bg-slate-800 text-slate-900 dark:text-white shadow-sm" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"
          )}
        >
          <CreditCard size={16} />
          Thanh toán
        ...
        <button
          ...
          className={cn(
            "flex items-center gap-2 px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all",
            activeTab === 'subdomain' ? "bg-white dark:bg-slate-800 text-slate-900 dark:text-white shadow-sm" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"
          )}
        >
          <Globe size={16} />
          Subdomain
        ...
        <button
          ...
          className={cn(
            "flex items-center gap-2 px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all",
            activeTab === 'templates' ? "bg-white dark:bg-slate-800 text-slate-900 dark:text-white shadow-sm" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"
          )}
        >
          <Layout size={16} />
          Mẫu in
        ...
        <button
          ...
          className={cn(
            "flex items-center gap-2 px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-all",
            activeTab === 'printers' ? "bg-white dark:bg-slate-800 text-slate-900 dark:text-white shadow-sm" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"
          )}
        >
          <Printer size={16} />
          Máy in
      ...
      <form onSubmit={handleSave} className="bg-white dark:bg-slate-900 p-8 rounded-[32px] border border-slate-100 dark:border-slate-800 shadow-2xl shadow-slate-200/40 dark:shadow-none">
          ...
          {activeTab === 'overview' ? (
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Tên quán</label>
                  <input
                    type="text"
                    name="storeName"
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-950 border-none rounded-2xl px-5 py-4 text-sm font-bold focus:ring-2 focus:ring-emerald-500 transition-all placeholder:text-slate-300 dark:placeholder:text-slate-700 text-slate-900 dark:text-white"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Hotline</label>
                  <input
                    type="text"
                    name="hotline"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Thuế (%)</label>
                  <input
                    type="number"
                    name="taxRate"
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-4">
                  <input
                    ...
                    className="flex-1 bg-slate-50 dark:bg-slate-950 border-none rounded-2xl px-5 py-4 text-sm font-bold focus:ring-2 focus:ring-emerald-500 transition-all placeholder:text-slate-300 dark:placeholder:text-slate-700 text-slate-900 dark:text-white"
                  />
                  <div className="w-14 h-14 bg-slate-50 dark:bg-slate-950 rounded-2xl border-2 border-dashed border-slate-200 dark:border-slate-800 flex items-center justify-center overflow-hidden">
                    {settings.logoUrl ? (
                      <img src={settings.logoUrl} alt="Logo Preview" className="w-full h-full object-contain" />
                    ) : (
                      <Upload size={20} className="text-slate-300 dark:text-slate-700" />
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Địa chỉ quán</label>
                <textarea
                  name="address"
                  ...
                  rows={3}
                  className="w-full bg-slate-50 dark:bg-slate-950 border-none rounded-2xl px-5 py-4 text-sm font-bold focus:ring-2 focus:ring-emerald-500 transition-all placeholder:text-slate-300 dark:placeholder:text-slate-700 text-slate-900 dark:text-white resize-none"
                />
              </div>
            </motion.div>
          ) : activeTab === 'payment' ? (
            ...
            >
              <div className="space-y-2 relative">
                <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Ngân hàng thụ hưởng</label>
                <div 
                  onClick={() => setShowBankList(!showBankList)}
                  className="w-full bg-slate-50 dark:bg-slate-950 rounded-2xl px-5 py-4 flex items-center justify-between cursor-pointer group hover:bg-slate-100 dark:hover:bg-slate-800 transition-all border-2 border-transparent focus-within:border-emerald-500 shadow-sm"
                >
                  <div className="flex items-center gap-4">
                    {settings.bankLogoUrl ? (
                      ...
                      <CreditCard size={20} className="text-slate-300 dark:text-slate-700" />
                    )}
                    <span className={cn("text-sm font-bold uppercase tracking-tight", settings.bankName ? "text-slate-900 dark:text-white" : "text-slate-300 dark:text-slate-700")}>
                      {settings.bankName || 'Chọn ngân hàng từ danh sách'}
                    </span>
                  </div>
                  <ChevronDown size={20} className={cn("text-slate-400 dark:text-slate-600 transition-transform", showBankList && "rotate-180")} />
                </div>
                ...
                <AnimatePresence>
                  {showBankList && (
                    <motion.div
                      ...
                      className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-2xl z-50 overflow-hidden flex flex-col max-h-[400px]"
                    >
                      <div className="p-4 border-b border-slate-50 dark:border-slate-800 sticky top-0 bg-white dark:bg-slate-900 z-10">
                        <div className="relative">
                          ...
                          <input 
                            ...
                            className="w-full bg-slate-50 dark:bg-slate-950 border-none rounded-xl pl-10 pr-4 py-2 text-xs font-bold focus:ring-2 focus:ring-emerald-500 text-slate-900 dark:text-white"
                            value={bankSearch}
                        ...
                        {filteredBanks.length > 0 ? (
                          filteredBanks.map(bank => (
                            <div 
                              ...
                              className="flex items-center gap-4 p-4 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 cursor-pointer transition-colors border-b border-slate-50 dark:border-slate-800 last:border-none"
                            >
                              <img src={bank.logo} alt={bank.shortName} className="h-6 w-auto object-contain bg-white rounded p-0.5" />
                              <div className="flex flex-col">
                                <span className="text-[10px] font-black text-slate-900 dark:text-white uppercase leading-none mb-1">{bank.shortName}</span>
                                <span className="text-[9px] text-slate-400 dark:text-slate-500 font-medium truncate max-w-[250px]">{bank.name}</span>
                              </div>
                          ...
                          <div className="p-8 text-center text-slate-400 dark:text-slate-600 text-[10px] font-black uppercase tracking-widest">Không tìm thấy ngân hàng</div>
                        )}
                      </div>
                    </motion.div>
                  )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Số tài khoản</label>
                  <input
                    type="text"
                    name="bankAccount"
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-950 border-none rounded-2xl px-5 py-4 text-sm font-bold focus:ring-2 focus:ring-emerald-500 transition-all placeholder:text-slate-300 dark:placeholder:text-slate-700 text-slate-900 dark:text-white font-mono"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Tên chủ tài khoản</label>
                  <input
                    type="text"
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-950 border-none rounded-2xl px-5 py-4 text-sm font-bold focus:ring-2 focus:ring-emerald-500 transition-all placeholder:text-slate-300 dark:placeholder:text-slate-700 text-slate-900 dark:text-white uppercase"
                  />
                </div>
              </div>
              ...
              <div className="p-6 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-800">
                <div className="flex gap-3 items-start">
                   <AlertCircle size={20} className="text-emerald-600 dark:text-emerald-400 mt-1" />
                   <div>
                      <p className="text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Thông báo thanh toán</p>
                      <p className="text-[10px] text-slate-500 dark:text-slate-400 leading-relaxed">Thông tin này sẽ được sử dụng để hiển thị mã QR chuyển khoản cho khách hàng khi thanh toán tại quầy hoặc tại bàn.</p>
                   </div>
                </div>
              </div>
            </motion.div>
                  ...
                  {!isDesigning ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4">
                        ...
                        <div 
                          ...
                          className={cn(
                            ...
                            settings.defaultPrintTemplate === template.id 
                               ? "bg-emerald-50 dark:bg-emerald-500/10 border-emerald-500 shadow-xl shadow-emerald-200/20" 
                               : "bg-white dark:bg-slate-900 border-slate-100 dark:border-slate-800 hover:border-emerald-200 dark:hover:border-emerald-500/50"
                          )}
                        >
                          <div className={cn(
                            "w-12 h-12 rounded-2xl flex items-center justify-center transition-colors",
                            settings.defaultPrintTemplate === template.id ? "bg-emerald-500 text-white" : "bg-slate-50 dark:bg-slate-800 text-slate-400 group-hover:text-emerald-500"
                          )}>
                            <Printer size={20} />
                          </div>
                          <div className="flex-1">
                            <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-widest mb-0.5">{template.name}</h4>
                            <p className="text-[9px] text-slate-500 dark:text-slate-400 font-medium leading-relaxed">{template.description}</p>
                          </div>
                          {settings.defaultPrintTemplate === template.id && (
                      ...
                      <div 
                        ...
                        className="p-5 rounded-[24px] border-2 border-dashed border-slate-200 dark:border-slate-800 flex items-center gap-4 bg-slate-50/50 dark:bg-slate-950/50 hover:bg-slate-50 dark:hover:bg-slate-900 transition-all cursor-pointer group"
                      >
                        <div className="w-12 h-12 bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center text-slate-300 dark:text-slate-700 group-hover:text-emerald-500 transition-colors">
                          <Plus size={20} />
                        </div>
                        <div className="flex-1">
                          <h4 className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-0.5">Tạo mẫu mới</h4>
                          <p className="text-[9px] text-slate-300 dark:text-slate-600 font-bold uppercase tracking-tight">Tự do kéo thả các trường thông tin</p>
                        </div>
                      </div>
                    </div>
                  ) : (
                    <div className="space-y-4">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Sắp xếp các trường</h4>
                        <div className="flex gap-2">
                          <button 
                            type="button" 
                            onClick={resetToDefault}
                            className="flex items-center gap-2 px-3 py-1.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 rounded-lg text-[9px] font-black uppercase tracking-widest hover:bg-slate-200 dark:hover:bg-slate-700 transition-all shadow-sm"
                          >
                            Mặc định
                          </button>
                          <button 
                            ...
                            className="flex items-center gap-2 px-3 py-1.5 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-lg text-[9px] font-black uppercase tracking-widest hover:bg-emerald-100 dark:hover:bg-emerald-500/20 transition-all shadow-sm"
                          >
                            <Plus size={12} />
                            Thêm trường
                          </button>
                      ...
                      >
                        ...
                        <DragOverlay dropAnimation={{
                          ...
                          {activeId ? (
                            <div className="flex items-center gap-3 p-3 bg-white dark:bg-slate-800 border-2 border-emerald-500 rounded-xl shadow-2xl opacity-90 scale-105">
            ...
            >
              <div className="flex justify-between items-center mb-6">
                 <div>
                   <h3 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-tight mb-1">Cấu hình máy in nhiệt</h3>
                   <p className="text-xs text-slate-500 dark:text-slate-400">Hỗ trợ các dòng Xprinter, Zywell, Gprinter, Xpos...</p>
                 </div>
                 <div className="flex gap-2">
                    <select 
                      className="bg-slate-100 dark:bg-slate-800 border-none rounded-xl px-4 py-2 text-[10px] font-black uppercase tracking-widest focus:ring-2 focus:ring-emerald-500 cursor-pointer text-slate-900 dark:text-white"
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-emerald-100 dark:hover:bg-emerald-500/20 transition-all shadow-sm"
                    >
                      <Plus size={14} />
                      Thêm thủ công
                    </button>
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-100 dark:hover:bg-blue-500/20 transition-all shadow-sm"
                    >
                      <Printer size={14} />
                      Quét USB
                    </button>
                     ...
                     <div key={pr.id} className="p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md transition-all group">
                        <div className="flex justify-between items-start">
                          <div className="flex gap-4">
                             ...
                             <div>
                               <div className="flex items-center gap-2 mb-1">
                                 <input 
                                   className="text-xs font-black text-slate-900 dark:text-white bg-transparent border-none p-0 focus:ring-0 uppercase tracking-tight w-40"
                                   value={pr.name}
                                   onChange={(e) => {
                                 ...
                                 <span className={cn(
                                   ...
                                   pr.status === 'ONLINE' ? "bg-emerald-100 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400" : "bg-red-100 dark:bg-red-500/10 text-red-600 dark:text-red-400"
                                 )}>
                                   {pr.status}
                                 </span>
                               </div>
                               <div className="flex gap-4 text-[10px] font-bold text-slate-400">
                                  ...
                                  <select 
                                    className="bg-transparent border-none p-0 focus:ring-0 cursor-pointer hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                                  ...
                                  <select 
                                    className="bg-transparent border-none p-0 focus:ring-0 cursor-pointer hover:text-orange-600 dark:hover:text-orange-400 transition-colors"
                                  ...
                                  {pr.type === 'LAN' && (
                                    <input 
                                      className="bg-transparent border-none p-0 focus:ring-0 text-slate-500 dark:text-slate-400 w-32"
                                      value={pr.address}
                                      onChange={(e) => {
                                        const updated = [...settings.printers];
                          ...
                          <div className="flex gap-2">
                             <button
                               type="button"
                               className="p-2 text-slate-300 dark:text-slate-700 hover:text-emerald-500 dark:hover:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 rounded-lg transition-all"
                               title="In thử"
                               onClick={() => {
                                 const testOrderData = {
              ...
              <div className="p-6 bg-amber-50 dark:bg-amber-500/10 rounded-2xl border border-amber-100 dark:border-amber-900 flex flex-col md:flex-row gap-4">
                 <AlertCircle size={20} className="text-amber-600 dark:text-amber-400 mt-1 shrink-0" />
                 <div>
                    <h4 className="text-xs font-black text-amber-900 dark:text-amber-500 uppercase mb-1">Hướng dẫn kết nối theo thiết bị</h4>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-3">
                       <div className="space-y-1">
                          <p className="text-[10px] font-black text-amber-800 dark:text-amber-600 uppercase">Máy tính (PC/Laptop)</p>
                          <p className="text-[9px] text-amber-700/70 dark:text-amber-700/50 leading-relaxed">Sử dụng "Quét USB" để nhận diện máy in cắm trực tiếp. Cần cài Driver nếu in qua Browser.</p>
                       </div>
                       <div className="space-y-1">
                          <p className="text-[10px] font-black text-amber-800 dark:text-amber-600 uppercase">Android</p>
                          <p className="text-[9px] text-amber-700/70 dark:text-amber-700/50 leading-relaxed">Bật Bluetooth và vị trí. Sử dụng "Quét Bluetooth" để tìm máy in nhiệt di động.</p>
                       </div>
                       <div className="space-y-1">
                          <p className="text-[10px] font-black text-amber-800 dark:text-amber-600 uppercase">iOS / iPad</p>
                          <p className="text-[9px] text-amber-700/70 dark:text-amber-700/50 leading-relaxed">Ưu tiên máy in LAN/WIFI. Với Bluetooth, cần app hỗ trợ hoặc trình duyệt có Web Bluetooth.</p>
                       </div>
                    </div>
                 </div>
              </div>
            ...
            <motion.div
              ...
              className="space-y-8"
            >
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20 p-6 rounded-3xl border border-emerald-100 dark:border-emerald-900">
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-white dark:bg-slate-900 rounded-2xl flex items-center justify-center shadow-sm text-emerald-600 dark:text-emerald-400">
                    <Globe size={24} />
                  </div>
                  <div>
                    <h3 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-tight mb-1">Cấu hình định danh</h3>
                    <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">Cấp quyền và quản lý đường dẫn truy cập riêng cho cửa hàng của bạn.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  <div className="flex items-center gap-2 mb-1">
                    <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Subdomain riêng</label>
                    <span className="px-2 py-0.5 bg-emerald-100 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 text-[8px] font-black rounded-full uppercase">Đề xuất</span>
                  </div>
                  <div className="relative group">
                    <input
                      ...
                      className="w-full bg-slate-50 dark:bg-slate-950 border-none rounded-2xl pr-32 pl-5 py-4 text-sm font-bold focus:ring-2 focus:ring-emerald-500 transition-all placeholder:text-slate-300 dark:placeholder:text-slate-700 text-slate-900 dark:text-white"
                    />
                    <div className="absolute right-5 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-600 text-xs font-black uppercase tracking-tight">
                      .{baseDomain}
                    </div>
                  </div>
                  <p className="text-[10px] text-slate-400 dark:text-slate-600 italic ml-1">Người dùng có thể truy cập qua: <span className="text-emerald-600 dark:text-emerald-400 font-bold">{settings.subdomain || 'yourshop'}.{baseDomain}</span></p>
                </div>

                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Đường dẫn tùy chỉnh (Slug)</label>
                  <div className="relative group">
                    <input
                      type="text"
                      name="customPath"
                      ...
                      className="w-full bg-slate-50 dark:bg-slate-950 border-none rounded-2xl pl-40 pr-5 py-4 text-sm font-bold focus:ring-2 focus:ring-emerald-500 transition-all placeholder:text-slate-300 dark:placeholder:text-slate-700 text-slate-900 dark:text-white"
                    />
                    <div className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-600 text-xs font-black uppercase tracking-tight">
                      {baseDomain}/
                    </div>
                  </div>
                  <p className="text-[10px] text-slate-400 dark:text-slate-600 italic ml-1">Hoặc qua đường dẫn: <span className="text-emerald-600 dark:text-emerald-400 font-bold">{baseDomain}/{settings.customPath || 'yourshop'}</span></p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                  <div 
                    onClick={fillWithUsername}
                    className="p-5 bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-sm hover:shadow-md transition-shadow cursor-pointer group"
                  >
                    <div className="w-8 h-8 bg-slate-50 dark:bg-slate-900 rounded-lg flex items-center justify-center text-slate-400 dark:text-slate-600 mb-3 group-hover:text-emerald-500 group-hover:bg-emerald-50 transition-colors">
                      <User size={16} />
                    </div>
                    <h4 className="text-[10px] font-black text-slate-900 dark:text-white uppercase mb-1">Theo tên người dùng</h4>
                    <p className="text-[9px] text-slate-400 dark:text-slate-500 leading-relaxed">Tự động sử dụng định danh dựa trên username của người quản trị cửa hàng.</p>
                  </div>
                  <div className="p-5 bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                    <div className="w-8 h-8 bg-slate-50 dark:bg-slate-900 rounded-lg flex items-center justify-center text-slate-400 dark:text-slate-600 mb-3 group-hover:text-emerald-500">
                      <LinkIcon size={16} />
                    </div>
                    <h4 className="text-[10px] font-black text-slate-900 dark:text-white uppercase mb-1">Liên kết vĩnh viễn</h4>
                    <p className="text-[9px] text-slate-400 dark:text-slate-500 leading-relaxed">Đường dẫn sẽ được bảo lưu và không thay đổi trừ khi có yêu cầu từ hệ thống.</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="mt-10 flex items-center justify-between border-t border-slate-100 dark:border-slate-800 pt-8">
          ...
          <button
            type="submit"
            disabled={saving}
            className="ml-auto flex items-center gap-2 px-10 py-4 bg-slate-900 dark:bg-emerald-600 text-white rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-emerald-600 dark:hover:bg-emerald-500 hover:scale-[1.02] transition-all shadow-xl disabled:opacity-50 disabled:hover:bg-slate-900 dark:disabled:hover:bg-emerald-600"
          >
            {saving ? (
